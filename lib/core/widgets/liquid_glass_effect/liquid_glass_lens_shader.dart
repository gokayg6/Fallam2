...
class LiquidGlassLensShader extends BaseShader {
  ...
  void updateShaderUniforms({
    ...
    // Set mouse position (indices 2-3) - Centered by default
    shader.setFloat(2, width / 2);
    shader.setFloat(3, height / 2);
    // Set effect size (index 4) - Configured Value: 5.0
    shader.setFloat(4, 5.0);
    // Set blur intensity (index 5) - Configured Value: 0.0
    shader.setFloat(5, 0);
    // Set dispersion strength (index 6) - Configured Value: 0.4
